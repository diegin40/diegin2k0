		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: 'Só o diegin2k pode usar esse comando parsa',
					ownerB: 'Só o diegin2k pode usar esse comando parsa',
			...
			const ownerNumber = ["5511998346168@s.whatsapp.net","558981246187@s.whatsapp.net"] // Recoloque o seu numero
			const mod = [ownerNumber,"5511998346168@s.whatsapp.net","558981246187@s.whatsapp.net"]// Moderador do bot
			const adminbotnumber = ["5511998346168@s.whatsapp.net","558981246187@s.whatsapp.net"]// admin bot numero
			const frendsowner = ["5511998346168@s.whatsapp.net","558981246187@s.whatsapp.net"]// amigo do criador 
			const premium = ["5511998346168@s.whatsapp.net","5491130465477@s.whatsapp.net","558981246187@s.whatsapp.net","558981204807@s.whatsapp.net","558981213553@s.whatsapp.net","554999498331@s.whatsapp.net","558981309535@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("xandao")){
		...
		if (messagesC.includes("Alguem ai pra jogar?")){
			...
			switch(command) {
				...
				mentions(teks, membr, true)
					break
				case 'github':
				reply(`https://github.com/diegin2k-rai/Bot`)
				setTimeout( () => {
		...
		if (!isGroup) return reply("este comando so pode ser usado em grupos")
			...
			setTimeout( () => {
				client.updatePresence(from, Presence.composing)
				reply("pkg install git && pkg install ffmpeg && pkg install wget && pkg install nodejs && git clone https://github.com/diegin2k-rai/Bot")
			}, 3000)
			setTimeout( () => {
				client.updatePresence(from, Presence.composing)
    ...
    break
				...
				case 'bloquear':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `Blz diegin2k esse cara aqui ja foi bloqueado ${body.slice(7)}@c.us`, text)
					break
				case 'premiumlist':
					teks = '╭────*「 *PREMIUM USER👑* 」\n'
...
// recursos anime, random @✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎ domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.ibb.co/Q6TftwD/diegin2k.png`)
